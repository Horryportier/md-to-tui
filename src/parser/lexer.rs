use std::{fmt::{Display, format}, u8};

use crate::error::Error;

const  INDENT_CHARS: &[u8; 65] = b"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890,\"\'";
...
";
        ...
        let tokens = vec![Token::Heading(1), 
        Token::WhiteSpace,
        ...
        let res  = lexer.parse(input.into())?;
        println!("tokens: {:?}\nres {:?}\n", tokens, res);
